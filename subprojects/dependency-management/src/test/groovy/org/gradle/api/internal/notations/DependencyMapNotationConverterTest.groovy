...
class DependencyMapNotationConverterTest extends Specification {
    ...
    def parser = NotationParserBuilder.toType(ExternalModuleDependency).converter(new DependencyMapNotationConverter<DefaultExternalModuleDependency>(TestUtil.attributesFactory(), DirectInstantiator.INSTANCE, DefaultExternalModuleDependency.class)).toComposite()
