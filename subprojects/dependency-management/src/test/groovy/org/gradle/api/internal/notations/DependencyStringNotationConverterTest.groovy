...
class DependencyStringNotationConverterTest extends Specification {
    def parser = new DependencyStringNotationConverter(TestUtil.attributesFactory(), DirectInstantiator.INSTANCE, DefaultExternalModuleDependency.class);
    ...
    def "can create client module"() {
        def parser = new DependencyStringNotationConverter(TestUtil.attributesFactory(), DirectInstantiator.INSTANCE, DefaultClientModule);
